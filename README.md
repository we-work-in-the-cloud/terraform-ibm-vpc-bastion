...
| disable\_public\_ip | Flag indicating that the bastion instance should be provisioned without attaching a floating ip. This configuration is useful for servers that are accessible behind a vpn server. | `bool` | `false` | no |
